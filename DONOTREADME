...
-reduced dex req for Phosphorescent Pole from 16 to 12
...
-increased Old Monk NPC int to 99, changed weapon loadout to just Phosphorescent Pole+5 and Insanity Catalyst, added Cling Ring and Fragrant Ring, changed NPC AI to Scirvir's, and changed equipped spells to Sludge Toss, Torpefy, and Homing Soul Arrow.

-changed black phantom Satsuki's item drop from Hiltless to Makoto, switched his primary and secondary right hand weapons so that he uses his Makoto+5, offset the hp degen effect with equal regen, increased magic stat to 30, and changed stock of 10 New Moon Grass to 2 Half Moon Grass
...
-changed Stockpile Thomas's stock of 99 Full Moon Grass to 4 Half Moon Grass

-changed Satsuki's stock of 10 New Moon Grass to 2 Half Moon Grass
