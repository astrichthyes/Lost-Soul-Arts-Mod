ProjectAstri_LostSoulArtsMod_v1.02
...
-added weak lifesteal effects to fatal weapons and Meat Cleaver HP drain visual effect
...
-added upgrades for Light Crossbow to +10

-added upgrades for Heavy Crossbow to +10

-added upgrades for Gargoyle Crossbow to +10

-reduced dex req for Phosphorescent Pole from 16 to 10 and increased magic req from 12 to 16

-increased Storm Ruler strength and dex scaling to 20

-added Sanctified Talisman, a talisman that has a weak Sincere Prayer special effect (stackable with the ring), 110 faith scaling, and a faith req of 24

-reduced Talisman of God scaling from 100 to 70

-reduced Morion Blade base physical AR to 0, increased base magic AR to 150, reduced dex req to 8, increased faith req to 16, increased faith scaling to 115 (up to 180 upgraded), made upgradeable with Colorless Demon's Souls, added Hiltless self-damage effect, and added hp-conditional regen on hit to offset self-damage at low hp

-added False Moonlight, a Large Sword of Moonlight replica with 100 physical AR that increases with upgrade, a strength req of 14, 150 durability, 6 unit weight, blunt damage, no ability to ignore shields, luck scaling, slightly above-standard stamina damage, and upgradeable with Colorless Demon's Souls

-all boss weapons now evolve from +0 weapons
...
-reduced 2h katana quick r2 modifier and increased stamina consumption to 85

-increased 2h greatsword first and second r2 modifiers

-reduced 2h dagger r2 modifier to 1.2
...
-standardized heavy armor durability to 500

-standardized medium cloth and leather armor durability to 300

-standardized light armor durability to 150
...
-visibility distance increased for Graverobber Ring and Thief's Ring

-audibility distance decreased for Graverobber Ring and Thief's Ring
...
-changed Recover soul cost to Maiden Astraea's Soul and changed hp recovery from 800 to 100%
...
-changed Acid Cloud to Sludge Toss, a spell that lobs sludge in an arc in front of the caster, which lingers on surfaces for several seconds; has 66 physical AR, costs 24mp, degrades equipment by 30 durability, and deals 90 buildup of poison that deals 0.6%hp/sec
...
-increased Regenerate regen to 1.5%HP/s

-changed Demon's Prank to Will-o-wisp, a spell that creates a slow-moving mid-range homing projectile that explodes on contact or after a set duration, costs 80mp, has 230 base Fire AR, takes up 2 slots, and is obtained by trading in the Tardigrade's Soul with Freke

-changed Hidden Soul to Emit Force, a miracle that sends out a small homing orb that explodes on contact or after a set duration, costs 40mp, has 256 physical AR, takes up 1 slot, and is obtained by trading in the Brain of a Mindflayer with either the Disciple of God or Saint Urbain
...
-changed properties of 5-2 poison swamp so that the player character is not restricted to the "overburdened" state (no roll) and instead has their maximum equip load reduced to 30%, with new icon indicating when the effect is active
...
-changed Spice MP recovery from flat to %MP regen and added MP regeneration aura and status icon for active spice effects
...
-increased Heavy Bolt physical AR to 80

-decreased Black Bold physical AR to 0 and increased magic AR to 40

-reduced consumable weapon buff weights to 0.1

-increased drop rate for Colorless Demon Soul from Primeval Demon to 100%

-increased number of White Arrows that Sparkly the Crow gives in trades to 30

-increased number of Colorless Demon Souls that Sparkly the Crow gives in trades to 3

-increased velocity of Throwing Knives to 35

-increased velocity of Kunai to 35

-increased velocity of Secret Throwing Dagger to 30

-added Soul of a Tardigrade item

-added Brain of a Mindflayer item to Mindflayer drop pools
...
-changed upgrade level of Garl's Bramd from +5 to +0
...
-changed 1-4 Penetrator NPC black phantom weapon to Crescent Flamberge+5, changed AI to match Scirvir black phantom, equipped Talisman of Beasts, equipped Homing Soul Arrow, Firestorm, Torpefy, Recovery, and Regenerate, changed armor to Monk's Head Wrap with Saint's Robes, increased magic to 24, increased faith to 24, increased vit to 30, increased intelligence to 99, and added NPC MP regen special effect

-changed Female Barbarian NPC black phantom equipment to Dozer Axe, full Chain armor set, equipped Ring of Great Strength, increased strength to 30, and increased faith to 24

-replaced Stone of Ephemeral Eyes Follower of God NPC gift with Sanctified Talisman
...
-increased black phantom Ostrava's faith to 18

-increased 1-4 Tower Shield NPC black phantom vit to 24

-increased 1-4 White Bow NPC vit to 20

-increased Old Monk NPC int to 99, changed weapon loadout to just Phosphorescent Pole+5 and Insanity Catalyst, added Cling Ring and Fragrant Ring, changed NPC AI to Scirvir's, disabled navmesh pathing, added NPC MP regen special effect, and changed equipped spells to Sludge Toss, Torpefy, and Homing Soul Arrow.

-changed black phantom Satsuki's item drop from Hiltless to Makoto, switched his primary and secondary right hand weapons so that he uses his Makoto+5, offset the hp degen effect with equal regen, increased magic stat to 30, and changed stock of 10 New Moon Grass to 6 Crescent Moon Grass

-changed 4-2 dual katanas black phantom weapons to Makoto, offset the hp degen effect with equal regen, and increased magic stat to 18

-changed Old King Doran's stock of 99 New Moon Grass to 2 Half Moon Grass

-changed Stockpile Thomas's stock of 99 Full Moon Grass to 10 Half Moon Grass

-changed Satsuki's stock of 10 New Moon Grass to 6 Crescent Moon Grass

-changed 2-2 male NPC black phantom equipment to Morion Blade, Chain armor set, Clever Rat Ring, and Dull Rat Ring; also increased Vitality to 25, Endurance to 30, and Faith to 16; also changed Chunk Dragonstone loot to Morion Blade

-changed 3-1 NPC black phantom equipment to Needle of Eternal Agony, Gargoyle's Crossbow, Black Bolts, and the Rogue armor set

-changed Acolyte of God NPC equipment to False Moonlight+5 and Mirdan armor set, increased his strength to 14, increased his vitality to 27, increased his endurance to 27, and added False Moonlight as a drop

-added Sanctified Talisman to Worshipper of God NPC equipment and drop, increased strength to 14, increased dexterity to 12, and changed right hand weapon to Blessed Mirdan Hammer+5

-changed Patches equipment to Fatal Short Spear+5 and increased his vitality to 24

-changed Biorr's crossbow bolts to Heavy Bolts and crossbow to Heavy Crossbow+10

-changed Urbain's talisman to Sanctified Talisman

-changed Freke's equipment to Baby's Nail+5 and Geri's Stiletto+5

-changed Disciple of God's weapon to Dragon Morning Star+5 and increased luck to 30

-changed Scirvir NPC black phantom weapons to Moon Short Sword+5 and Geri's Stiletto+5

-added new Disciple of God NPC black phantom in 5-2 with Dragon Morning Star+5, Sanctified Talisman, Penitent Nails, Cloud of Flies, Regeneration, and Anti-Magic Barrier

-added new Yurt NPC black phantom in 3-2 with dual Mercury Shotel+5

-added new NPC black phantom in 4-2 with Tearing Pickaxe+5, Simpleton's Catalyst, Will-o-wisp, and Rock Throw

-added new NPC black phantom in 2-2 with dual Hands of God+5

-added new NPC black phantom in 4-1 with Baby's Nail+5, Silver Catalyst, Wind Slice, and Sludge Toss
...
-added Colorless Demon Soul in Patches NPC shop and set cost to 30000 souls
...
-increased all kick stamina cost to 50

-changed 2h dagger r2 to foot sweep that ignores shields
...
-changed description of Morion Blade to describe new self-damage effect and scaling with lore context

-changed description of Black Bolt to describe new magic damage type with lore context

-changed description of Buckler to remove misleading comment suggesting the shield has more parry frames than other shields

-added description of Sanctified Talisman to describe it with lore context

-changed name and description of Demon's Prank to Will-o-wisp to describe new effect with lore context

-added description of Tardigrade's Soul to describe item with lore context

-changed description of Secret Throwing Dagger for more accuracy

-changed description of Pickaxe for more accuracy

-changed name and description of Hidden Soul to Emit Force to describe new effect with lore context

-added description of Brain of a Mindflayer to describe item with lore context

----------------------------------

Icon Edits

-changed color of Demon's Prank icon to appropriately represent the new Will-o-wisp spell

-created custom icon for Flame Weapon

-created custom icon for Torpefy

-changed Sludge Toss icon to green skull

-changed icon for Sanctified Talisman to red talisman icon

-created custom icon for Rock Throw

-slightly changed color of Anti-Magic Barrier icon to be more green

-created custom icon for 5-2 swamp roll mechanic

-created custom icon for Emit Force
...
-replaced Temple Knight "Antidote" (Flame Weapon) with Evacuate

-increased Priest class faith to 16, reduced vit to 19, reduced int to 10, reduced strength to 12, and moved talisman to left hand
...
-added enemies in some low-density areas in various maps

-changed loot from Crescent Moon Grass to Soul of a Miner in 2-1

-changed loot for dagger corpse in 4-2

-removed chairs from Old Monk boss room and added new objects around pillars

-changed loot from Blessed Mace+1 in 5-1 to 12 Crescent Moon Grass

-changed loot from Thief's ring in 5-2 to Blessed Mace+1

-changed loot from Crescent Falchion in 4-1 to Stone of Ephemeral Eyes

-changed loot from Crescent Moon Grass in 4-2 to Crescent Falchion+1

-changed loot from Fabled Hero's Soul in 4-3 to Morion Blade

-moved 1-1 Spear Knight to platform with Light Crossbow

-moved 2-2 male NPC black phantom to 1-1 outside mausoleum door

-changed loot from Crescent Moon Grass in 5-1 to False Moonlight

-changed loot from New Moon Grass to Tardigrade's Soul in 2-3

-moved 5-2 Nameless Soldier Soul corpse near new NPC black phantom, added wood debris for the corpse to lean against, and changed loot to Colorless Demon Soul

-moved two treasure corpses in 3-1 swamp closer to black phantom Yurt

-moved some objects in 1-1, as well as some treasure corpses

-added a few more enemies in 1-2

----------------------------------
1.02 Bug fixes:

-fixed bug with catalyst and talisman kicks granting i-frames
