...
-added Sanctified Talisman, a talisman that has the Sincere Prayer special effect, 110 faith scaling, and a faith req of 24
...
-changed Demon's Prank to Will-o-wisp, a spell that creates a slow-moving mid-range homing projectile that explodes on contact or after a set duration, costs 80mp, has 230 base Fire AR, and is obtained by trading in the Armored Spider Soul with Freke.
...
-increased Old Monk NPC int to 99, changed weapon loadout to just Phosphorescent Pole+5 and Insanity Catalyst, added Cling Ring and Fragrant Ring, changed NPC AI to Scirvir's, disabled navmesh pathing, and changed equipped spells to Sludge Toss, Torpefy, and Homing Soul Arrow.
...
-added 1 Colorless Demon Soul in Patches NPC shop and set cost to 100000 souls
...
-new spell ideas: leachmonger leach ball, tower knight javelin, lava throw, some kind of short-mid range spear thrust spell?
