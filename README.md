...
-reduced Makoto base physical AR to 0 for all variants, increased base magic AR to 120, added 18 magic stat requirement, and increased magic scaling to 100+20*upgradelevel
...
-changed description of Spices to describe new effects
...
-fix bad enemy AI?
-add ring to allow normal movement in swamp? might be tied to NPC-exclusive effects
